...
#### Fase 1: Instalación y Configuración en Kali Linux (VM)
...
#### Fase 2: Preparación del Código de Prueba (Vulnerable)
...
#### Fase 3: Despliegue de SonarQube
...
#### Fase 4: Configuración de Seguridad y Accesos en la Interfaz Web
...
#### Fase 5: Análisis de Código Estático (SAST) mediante SonarScanner
...
#### Fase 6: Creación de Quality Profile y Reglas SAST
...
#### Fase 7: Revisión de Resultados y Quality Gates
...
#### Fase 8: Remediación y Validación (Passed)
...
#### Phase 1: Installation and Configuration on Kali Linux (VM)
...
#### Phase 2: Preparation of Test Code (Vulnerable)
...
#### Phase 4: Security Configuration and Access via Web UI
...
#### Phase 5: Static Code Analysis (SAST) using SonarScanner
...
#### Phase 6: Creating a Quality Profile and SAST Rules
...
#### Phase 7: Results Review and Quality Gates
...
#### Phase 8: Remediation and Quality Gate Validation (Passed)
